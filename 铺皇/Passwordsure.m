...
@interface Passwordsure ()<UITextFieldDelegate>
...
-(void)addDetailViews{
    ...
    self.bgView.frame = CGRectMake(KMainScreenWidth, self.center.y-140, KMainScreenWidth-40, 200);
    self.bgView.layer.cornerRadius = 15;
    self.bgView.layer.masksToBounds = YES;
    [self addSubview:self.bgView];
    
    self.titlaLabel.text = @"再次输入支付密码";
...
-(void)show
{
    ...
    [UIView animateWithDuration:0.5 animations:^{
        ...
        self.bgView.frame = CGRectMake(20, self.center.y-140, KMainScreenWidth-40, 200);
...
-(void)cancelBtnClicked
{
    ...
    [UIView animateWithDuration:0.2 animations:^{
        ...
        self.bgView.frame = CGRectMake(0, KMainScreenHeight, KMainScreenWidth, KMainScreenHeight-320);
...
-(UIImageView *)circleSmallView1{
    ...
    if (!_circleSmallView1) {
        ...
        _circleSmallView1.image = [UIImage imageNamed:@"黑点@2x"];
...
-(UIImageView *)circleSmallView2{
    ...
    if (!_circleSmallView2) {
        ...
        _circleSmallView2.image = [UIImage imageNamed:@"黑点@2x"];
...
-(UIImageView *)circleSmallView3{
    ...
    if (!_circleSmallView3) {
        ...
        _circleSmallView3.image = [UIImage imageNamed:@"黑点@2x"];
...
-(UIImageView *)circleSmallView4{
    ...
    if (!_circleSmallView4) {
        ...
        _circleSmallView4.image = [UIImage imageNamed:@"黑点@2x"];
...
-(UIImageView *)circleSmallView5{
    ...
    if (!_circleSmallView5) {
        ...
        _circleSmallView5.image = [UIImage imageNamed:@"黑点@2x"];
...
-(UIImageView *)circleSmallView6{
    ...
    if (!_circleSmallView6) {
        ...
        _circleSmallView6.image = [UIImage imageNamed:@"黑点@2x"];
...
-(UIView *)bgView{
    if (!_bgView) {
        _bgView = [[UIView alloc]initWithFrame:CGRectMake(KMainScreenWidth, KMainScreenHeight/2-70, KMainScreenWidth, KMainScreenWidth/2)];
...
-(UIButton *)cancelBtn{
    if (!_cancelBtn) {
        ...
        [_cancelBtn setBackgroundImage:[UIImage imageNamed:@"撤销@2x"] forState:UIControlStateNormal];
