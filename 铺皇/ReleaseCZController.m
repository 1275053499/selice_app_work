...
@interface ReleaseCZController ()<UIAlertViewDelegate,UITableViewDataSource, UITableViewDelegate,TZImagePickerControllerDelegate,UICollectionViewDataSource,UICollectionViewDelegate,UIActionSheetDelegate,UIImagePickerControllerDelegate,UIAlertViewDelegate,UINavigationControllerDelegate,UITextFieldDelegate>{
...
@property (nonatomic,strong)UILabel         *ZRtransfer;//租金类型
...
@implementation ReleaseCZController
-(NSArray*)photosArr{
    if (!_photosArr) {
...
#pragma mark  店铺租金类型
    _ZRtransfer                     = [[UILabel alloc]initWithFrame:CGRectMake(75, 0, KMainScreenWidth-100, 50)];
    _ZRtransfer.textAlignment       = NSTextAlignmentRight;
    _ZRtransfer.font                = [UIFont systemFontOfSize:14.0];
    _ZRtransfer.text                = @"请选择";
...
- (void)configKeyBoardRespond {
    ...
    __weak ReleaseCZController *weakSelf = self;
...
#pragma explain - use animateWhenKeyboardAppearBlock, animateWhenKeyboardAppearAutomaticAnimBlock will be invalid.
    ...
    [_keyboardUtil setAnimateWhenKeyboardAppearAutomaticAnimBlock:^(ZYKeyboardUtil *keyboardUtil) {
        [keyboardUtil adaptiveViewHandleWithController:weakSelf adaptiveView:weakSelf.ZRname, weakSelf.ZRarea, weakSelf.ZRrent,weakSelf.ZRperson,weakSelf.ZRnumber, nil];
    }];
        ...
        if (indexPath.section == 0) {
            ...
            switch (indexPath.row){
                ...
                case 3:{
                    ...
                    cell.textLabel.text=@"租金类型";
                    [cell.contentView addSubview:_ZRtransfer];
                        ...
                        SRActionSheet *actionSheet = [SRActionSheet sr_actionSheetViewWithTitle:nil
                                                                              ...
                                                                              selectActionBlock:^(SRActionSheet *actionSheet, NSInteger index) {
                                                                                  ...
                                                                                  switch (index) {
                                                                                      case 0:
                                                                                      {
                                                                                          _ZRtransfer.text = @"押三付一";
                                                                                          _ZRtransfer.textColor = [UIColor colorWithRed:77/255.0 green:166/255.0 blue:214/255.0 alpha:1.0 ];//主题色
                                                                                          
                                                                                      }
                                                                                          break;
                                                                                      case 1:
                                                                                      {
                                                                                          _ZRtransfer.text = @"押二付一";
                                                                                          _ZRtransfer.textColor = [UIColor colorWithRed:77/255.0 green:166/255.0 blue:214/255.0 alpha:1.0 ];//主题色
...
-(void)upload{
    ...
    if (phoneRight != 0){
        ...
        if(_selectedPhotos.count<=0||
           ...
           [self.ZRtransfer.text isEqualToString:@"请选择"]||
           ...
           [self.ZRSupportlab.text isEqualToString:@"请填写信息"]||[self.ZRSupportlab.text isEqualToString:@"您尚未填写信息"]){
            ...
            [YJLHUD dismiss];
            UIAlertController *alertController = [UIAlertController alertControllerWithTitle:@"提示" message:@"好像漏掉了什么信息，需要检查完善一下" preferredStyle:UIAlertControllerStyleAlert];
